...
- Area-specific knowledge: the user's locations (from `user/context.json`) and anywhere the operator or clients need
...
### Proactive
- "New akiya listing near you matches your client's criteria"
